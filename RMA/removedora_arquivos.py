...
if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_gerados.csv')): os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_gerados.csv'))
if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_encontrados.csv')): os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_encontrados.csv'))
if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'pontos.csv')): os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'pontos.csv'))
...
if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_indices_trocados.csv')): os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_indices_trocados.csv'))

...
export GAZEBO_MODEL_PATH=$HOME/workspace/src/RMA/models
...
pre_input="export UAV_NAME=uav1; export RUN_TYPE=simulation; export UAV_TYPE=f450; export WORLD_NAME=simulation; export WORLD_FILE=./world.yaml; export SENSORS='garmin_down'"

...
def main():
    ...
    sx = (xOrigem*proporcioal)        # X inicial
    sy = (yOrigem*proporcioal)        # Y inicial
    gx = (xDestino*proporcioal)       # X final
    gy = (yDestino*proporcioal)       # Y final
    grid_size = 0.5*proporcioal         # Distâncias entre as esquinas
    robot_radius = (0.8*proporcioal)  # Tamanho do robô
    ...
    #     Pontos.append([(rx[-1-i] - sx)*proporcioal, (ry[-1-i] - sy)*proporcioal]) # Armazena os pontos gerados

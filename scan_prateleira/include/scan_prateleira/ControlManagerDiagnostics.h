...
struct ControlManagerDiagnostics_
{
  ...
  _stamp_type stamp;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _uav_name_type;
  ...
  _rc_mode_type rc_mode;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _active_tracker_type;
  ...
  _available_controllers_type available_controllers;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > , typename ContainerAllocator::template rebind<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::other >  _available_trackers_type;
  _available_trackers_type available_trackers;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _human_switchable_controllers_type;
  _human_switchable_controllers_type human_switchable_controllers;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _human_switchable_trackers_type;
...
struct Printer< ::mrs_msgs::ControlManagerDiagnostics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mrs_msgs::ControlManagerDiagnostics_<ContainerAllocator>& v)
  {
    ...
    s << indent << "uav_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.uav_name);
    s << indent << "motors: ";
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.active_tracker);
    ...
    for (size_t i = 0; i < v.available_controllers.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.available_controllers[i]);
    }
    s << indent << "available_trackers[]" << std::endl;
    for (size_t i = 0; i < v.available_trackers.size(); ++i)
    {
      s << indent << "  available_trackers[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.available_trackers[i]);
    }
